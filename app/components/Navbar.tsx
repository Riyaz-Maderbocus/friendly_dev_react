...
const Navbar = () => {
    ...
    return (  
        <nav className="bg-gray-800 border-b border-gray-700 shadow-md stick top-0 z-50">
            ...
            {/* Mobile Nav */}
            {menuOpen && (
                <div className="md:hidden text-white bg-gray-800 border-t border-gray-100 px-6 py-4 space-y-2 space-x-4 text-center">
